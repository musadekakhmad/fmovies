...
export async function generateMetadata({ params }) {
  ...
  const pageUrl = `https://fmoviestream.netlify.app/movie/genre/${genreName}`;
  const imageUrl = 'https://live.staticflickr.com/65535/54783431146_cea3af132d_b.jpg';

  return {
    title: `Fmovies Stream - ${title} Movies`,
    description: `Find and watch the best ${title} movies for free on Fmovies Stream.`,
    openGraph: {
      title: `Fmovies Stream - ${title} Movies`,
      description: `Find and watch the best ${title} movies for free on Fmovies Stream.`,
      url: pageUrl,
